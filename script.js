...
function updateClock(){
    ...
    let dname = now.getDay(),
        ...
        Number.prototype.sol = function(digits){
        ...
        let values = [week[dname], months[mo], dnum.sol(2),yr,hou.sol(2),min.sol(2),sec.sol(2),pe];
        ...
        for(let i=0; i<alarmListArr.length;i++){
            if(alarmListArr[i]==`${hou.sol(2)}:${min.sol(2)}:${sec.sol(2)} ${pe}`){
